...
print(validation_curve(RandomForestClassifier(),dataset.XEng, dataset.YEng, param_name='n_estimators', param_range=estimatorsRange, scoring="accuracy"))
print(validation_curve(RandomForestClassifier(),dataset.XEng, dataset.YEng, param_name='min_samples_split', param_range=minSplitRange, scoring="accuracy"))
print(validation_curve(RandomForestClassifier(),dataset.XEng, dataset.YEng, param_name='min_samples_leaf', param_range=minLeafRange, scoring="accuracy"))
print(validation_curve(RandomForestClassifier(),dataset.XEng, dataset.YEng, param_name='max_features', param_range=maxFeaturesRange, scoring="accuracy"))

print(validation_curve(RandomForestClassifier(),dataset.XMaths8,dataset.YMaths8, param_name='n_estimators', param_range=estimatorsRange, scoring="accuracy"))
print(validation_curve(RandomForestClassifier(),dataset.XMaths8,dataset.YMaths8, param_name='min_samples_split', param_range=minSplitRange, scoring="accuracy"))
print(validation_curve(RandomForestClassifier(),dataset.XMaths8,dataset.YMaths8, param_name='min_samples_leaf', param_range=minLeafRange, scoring="accuracy"))
print(validation_curve(RandomForestClassifier(),dataset.XMaths8,dataset.YMaths8, param_name='max_features', param_range=maxFeaturesRange, scoring="accuracy"))

##Exhaustive grid search to find best parameters
print("Exhaustive Grid Search...")

hyperF = dict(n_estimators = estimatorsRange, max_features = maxFeaturesRange, min_samples_split = minSplitRange, min_samples_leaf = minLeafRange)
...
RFClassifierEng = RandomForestClassifier(n_estimators=89, max_features=3, min_samples_leaf=2, min_samples_split=2, n_jobs=-1, random_state=1)

##exhaustive params
RFClassifierMath8 = RandomForestClassifier(n_estimators=81, max_features=5, min_samples_leaf=2, min_samples_split=3, n_jobs=-1, random_state=1)

print("Cross Val")
scoring = ["precision_macro", "recall_macro", "f1_macro"]
EngScores = cross_validate(RFClassifierEng, dataset.XEng, dataset.YEng, cv=5, scoring=scoring)

MathsScores = cross_validate(RFClassifierEng, dataset.XMaths8, dataset.YMaths8, cv=5, scoring=scoring)

print("English")
print("Precission ", EngScores['test_precision_macro'].mean())
print("Recall ", EngScores['test_recall_macro'].mean())
print("F1 ", EngScores['test_f1_macro'].mean())

print("Maths8")
print("Precision ", MathsScores['test_precision_macro'].mean())
print("Recall ", MathsScores['test_recall_macro'].mean())
print("F1 ", MathsScores['test_f1_macro'].mean())
...
for x in range(0,5):
    ##split dataset
    xTrainE, XTestE, YTrainE, YTestE = train_test_split(dataset.XEng, dataset.YEng, test_size=0.2, random_state= x+1)
    ...
    ##split dataset
    xTrainM, XTestM, YTrainM, YTestM = train_test_split(dataset.XMaths8, dataset.YMaths8, test_size=0.2, random_state= x+1)
...
print("Precision per Class", classPrecisionEnglish)
print("Recall per Class", classRecallEnglish)
print("F1 per Class", classF1English)
...
print("Precision per Class", classPrecisionMaths)
print("Recall per Class", classRecallMaths)
print("F1 per Class", classF1Maths)

##average confusion matrixs across folds
meanCME = np.mean(conMListEng, axis=0)
meanCMM = np.mean(conMListMaths, axis=0)

cme = pd.DataFrame(meanCME, ['a1','a2','a3','a4','a5','a6','a7','a8','a9'],['p1','p2','p3','p4','p5','p6','p7','p8','p9'])
cmm = pd.DataFrame(meanCMM, ['a1','a2','a3','a4','a5','a6','a7','a8'],['p1','p2','p3','p4','p5','p6','p7','p8'])
